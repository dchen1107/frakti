...
type Container struct {
	...
	// image ID.
	ImageRef *string `protobuf:"bytes,3,opt,name=image_ref" json:"image_ref,omitempty"`
	// State is the state of the container.
	State *ContainerState `protobuf:"varint,4,opt,name=state,enum=runtime.ContainerState" json:"state,omitempty"`
	// Labels are key value pairs that may be used to scope and select individual resources.
	Labels           map[string]string `protobuf:"bytes,5,rep,name=labels" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_unrecognized []byte            `json:"-"`
}
...
type ContainerStatus struct {
	...
	// Reference to the image in use. For most runtimes, this should be an
	// image ID
	ImageRef *string `protobuf:"bytes,8,opt,name=image_ref" json:"image_ref,omitempty"`
	...
	Annotations map[string]string `protobuf:"bytes,11,rep,name=annotations" json:"annotations,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Mounts specifies mounts for the container
	Mounts           []*Mount `protobuf:"bytes,12,rep,name=mounts" json:"mounts,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}
...
type RuntimeServiceClient interface {
	...
	// CreatePodSandbox creates a pod-level sandbox. PodSandbox is interpreted
	// differently in different runtimes.  For docker, this may mean
	// creating the infra container. For hyper, this can create the
	// virtual machine.
